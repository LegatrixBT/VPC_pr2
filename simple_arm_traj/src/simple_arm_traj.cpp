...
public:
  ...
  void startTrajectory(pr2_controllers_msgs::JointTrajectoryGoal goal, float delay)
  {
  ...
  */
  ...
  //! Returns the string of the current state of the action
  std::string showState()
  {
    return traj_client_->getState().toString() ;
  }
